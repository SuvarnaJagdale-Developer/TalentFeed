...
export default class TalentFeed extends React.Component {
    ...
    getTalentSnapshotList(position, number) {
        ...
        $.ajax({
            url: `http://advancedtalentprofile.azurewebsites.net/profile/profile/getTalent`,
    ...
    getCompanyData() {
        ...
        $.ajax({
            ...
            url: 'http://advancedtalentprofile.azurewebsites.net/profile/profile/getEmployerProfile',
            headers: {
